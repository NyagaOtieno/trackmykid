...
const Sidebar = React.forwardRef(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
    ...
    if (isMobile) {
        return (_jsx(Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props, children: _jsxs(SheetContent, { "data-sidebar": "sidebar", "data-mobile": "true", className: "w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden z-[2000]", style: {
                    "--sidebar-width": SIDEBAR_WIDTH_MOBILE,
                }, side: side, children: [_jsx(SheetTitle, { className: "sr-only", children: "Sidebar navigation" }), _jsx(SheetDescription, { className: "sr-only", children: "Use the menu links to move between sections." }), _jsx("div", { className: "flex h-full w-full flex-col", children: children })] }) }));
    }
